<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
      <div class="title-container"><h3 class="title">后台登录</h3></div>
      ...
      <el-form-item prop="verification">
        ...
        <el-input ref="verification" v-model="loginForm.verification" placeholder="验证码" name="verification" type="text" tabindex="1" autocomplete="on" />
      </el-form-item>
