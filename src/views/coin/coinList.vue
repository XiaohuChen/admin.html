      ...
      <el-table-column label="Logo" align="center">
        <template slot-scope="scope">
          <span v-if="scope.row.Logo">
            <img :src="qiniu.Domain + scope.row.Logo" width="50px">
          </span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title=title :visible.sync="CoinAddVisible">
      <el-form>
        ...
        <el-form-item label="简介" label-width="130px">
          <el-input type="textarea" v-model="coin.Description"></el-input>
        </el-form-item>
        ...
        <el-form-item label="是否可提现" label-width="130px">
          <el-radio label="1" v-model="coin.IsWithDraw">是</el-radio>
          <el-radio label="0" v-model="coin.IsWithDraw">否</el-radio>
        </el-form-item>
        <el-form-item label="是否可充值" label-width="130px">
          <el-radio label="1" v-model="coin.IsRecharge">是</el-radio>
          <el-radio label="0" v-model="coin.IsRecharge">否</el-radio>
        </el-form-item>
        <el-form-item label="是否自动处理" label-width="130px">
          <el-radio label="1" v-model="coin.IsAutoWithDraw">是</el-radio>
          <el-radio label="0" v-model="coin.IsAutoWithDraw">否</el-radio>
        </el-form-item>
        <el-form-item label="状态，是否启用" label-width="130px">
          <el-radio label="1" v-model="coin.Status">是</el-radio>
          <el-radio label="0" v-model="coin.Status">否</el-radio>
        </el-form-item>
        ...
        <el-form-item label="充值文字描述" label-width="130px">
          <el-input type="textarea" v-model="coin.RechargeInfo"></el-input>
        </el-form-item>
        <el-form-item label="提现文字描述" label-width="130px">
          <el-input type="textarea" v-model="coin.WithDrawInfo"></el-input>
        </el-form-item>
      ...
      iconUpdateHandle(row) {
        ...
        getCoin(row.Id).then(res => {
          if (res.code == 20000) {
            ...
            this.CoinAddVisible = true
            this.imageUrl = this.qiniu.Domain + res.data.Logo;
            this.coin.Logo = res.data.Logo;
